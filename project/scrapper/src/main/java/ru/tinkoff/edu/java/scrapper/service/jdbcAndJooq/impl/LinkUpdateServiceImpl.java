...
import Link.GithubParseResult;
import Link.ParseResult;
import Link.StackOverflowParseResult;
...
public class LinkUpdateServiceImpl implements LinkUpdateService {
    ...
    public void updateStackOverflowLink(Link link, ParserLink result) {
        try {
            ...
            StackOverflowItem response =
                stackOverflowClient.fetchQuestion(((StackOverflowLink) result).id());
